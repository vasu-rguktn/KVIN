...
BODY_PART_MODEL_PATH = os.path.join(THIS_FOLDER, "weights", "ResNet50_BodyParts_unfreeze_no_aug.keras")
FRACTURE_MODEL_PATHS = {
    "Elbow":    os.path.join(THIS_FOLDER, "weights", "ResNet50_Elbow_frac_unfreeze_no_aug.keras"),
    "Hand":     os.path.join(THIS_FOLDER, "weights", "ResNet50_Hand_frac_unfreeze_no_aug.keras"),
    "Shoulder": os.path.join(THIS_FOLDER, "weights", "ResNet50_Shoulder_frac_unfreeze_no_aug.keras"),
}
