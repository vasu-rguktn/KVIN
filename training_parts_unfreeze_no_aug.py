...
train_ds = build_dataset(train_df, training=True,  cache_name="cache_train_unfreeze_no_aug.tf")
val_ds = build_dataset(val_df, training=False, cache_name="cache_val_unfreeze_no_aug.tf")
test_ds = build_dataset(test_df, training=False, cache_name="cache_test_unfreeze_no_aug.tf")
...
model.save("weights/ResNet50_BodyParts_unfreeze_no_aug.keras")
...
plt.savefig(os.path.join(plot_dir, "confusion_matrix_unfreeze_no_aug.jpeg"))
plt.close()

cm_df = pd.DataFrame(cm, index=le.classes_, columns=le.classes_)
cm_df.to_csv(os.path.join(plot_dir, "confusion_matrix_unfreeze_no_aug.csv"))
